...
namespace HTTPMan
{
    public class HttpImporter
    {
        ...
        /// <returns>A HttpRequest object which cand either be fully intialized or null in case the input file was not valid.</returns>
#nullable enable
...
#nullable disable
        ...
        /// <returns>Request object if file valid and null if file is invalid.</returns>
# nullable enable
